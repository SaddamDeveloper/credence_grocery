              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-product-hunt" aria-hidden="true"></i> Products <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li class="sub_menu"><a href="{{route('admin.product_add_form')}}">Add Grocery Items</a></li>
                      {{-- <li class="sub_menu"><a href="{{route('admin.meat_add_form')}}">Add Meat Items</a></li> --}}
                      <li class="sub_menu"><a href="{{route('admin.product_list')}}">Grocery Item List</a></li>
                      {{-- <li class="sub_menu"><a href="{{route('admin.product_meat_list')}}">Meat Item List</a></li> --}}
                    </ul>
                  </li>
