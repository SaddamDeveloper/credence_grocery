    	...
    	<div class="col-md-12 col-xs-12 col-sm-12" style="margin-top:50px;">
    	    <div class="x_panel">
    	        ...
    	        <div class="x_title">
                    ...
                    <a class="btn btn-sm btn-info" style="float: right" href="{{route('admin.category_add_form')}}">Add New Main Category</a>
                            ...
                            @endphp
                                @foreach ($category as $item)
                                    <tr>
                                      <td>{{$count++}}</td>
                                      <td>{{$item->name}}</td>
                                      <td><img src="{{asset('images/category/category/thumb/'.$item->image.'')}}" height="100" /></td>
                                      <td>
                                        @if ($item->status == '1')
                                      ...
                                      <td>
                                        <a href="{{route('admin.category_edit',['id'=>encrypt($item->id)])}}" class="btn btn-sm btn-warning">Edit</a>
                                        @if ($item->status == '1')
