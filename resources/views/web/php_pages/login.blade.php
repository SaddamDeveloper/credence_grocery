                        ...
                        <div class="content">
                            ...
                            <form action="http://assamproducts.webinfotechghy.xyz/login" autocomplete="off" method="POST">
                                ...
                                <div class="buttons-set">
                                    ...
                                    <a class="forgot-word" target="_blank" href="forgot-password.php">Forgot Your Password?</a>
                                </div>
                            </form>
                            <hr>
                            <p>If you don't have an account with us, please register in.</p>
                            <a class="button login " href="http://assamproducts.webinfotechghy.xyz/registration-page">CREATE AN ACCOUNT</a>
                        </div>
                    </div>
                </fieldset>
            </div>
