                            ...
                            <form method="POST" action="" method="POST">
                              ...
                              <ul>
                                <li class="row">
                                  ...
                                  <input type="text" value="" class="input form-control" name="name" id="name">
                                    <span id="name_msg" style="color: red;"></span>
                                  </div>
                                  <!--/ [col] -->
                                  <div class="col-sm-6">
                                    <label for="email_address" class="required">Email Address</label>
                                    <input type="email" class="input form-control" value="" name="email" id="email_address">
                                ...
                                <li class="row">
                                  <div class="col-sm-6">
                                    ...
                                    <input type="number" name="mobile_no" value="" class="input form-control" id="telephone">
                                    <span id="telephone_msg" style="color: red;"></span>
                                  </div>
                                  <!--/ [col] -->
                                  <div class="col-sm-6">
                                    <label for="postal_code" class="required">Pincode</label>
                                    <input type="number" class="input form-control" value="" name="pin_code" id="postal_code">
                                ...
                                <li class="row">
                                  <div class="col-sm-6">
                                    ...
                                    <input class="input form-control" type="text" value="" name="city" id="city">
                                  ...
                                  <div class="col-sm-6">
                                    ...
                                    <input type="text" class="input form-control" value="" name="state" id="state">
